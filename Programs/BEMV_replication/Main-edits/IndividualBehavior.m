...
[ iBot, iTop, ~,~, frac ]   = Brackets2fast( SnGrid_zn, Sn_zn.*exp(-n_zn), Nz*Nn, 1, Nz*Nn, options ) ; % Locate indices on SnGrid such that Sn lies in between, and specify position (frac)

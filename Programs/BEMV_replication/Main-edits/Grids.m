...
function [ NumGrids ] = Grids( Numerical, Params, options )
...
nmin    = Numerical.nmin ;  % Lowest n gridpoint
nmax    = Numerical.nmax ;  % Highest n gridpoint
